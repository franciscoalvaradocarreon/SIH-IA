        ...
        <div className="p-6">
            ...
            {loading ? (
                ...
                <>
                    ...
                    {/* Paginación */}
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 bg-white dark:bg-gray-800 px-4 py-3 rounded-lg shadow-sm border border-gray-400 dark:border-gray-700">

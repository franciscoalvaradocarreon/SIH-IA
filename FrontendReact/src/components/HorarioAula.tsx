  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Matriz o mensajes vacíos.
          Mismo cuidado que en la vista por maestro: si ya hay filas pintadas, la tabla NO se
          desmonta mientras carga. Al quitarla la pagina encogia, el navegador recortaba el scroll
          y al pulsar Anterior o Siguiente la vista saltaba al inicio. La vista por grupo nunca lo
          hizo porque no oculta nada. El spinner centrado se reserva para la primera carga. */}
